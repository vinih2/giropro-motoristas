  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-xl mb-2">Recursos Profissionais para Aumentar Sua Renda</p>
        <p className="text-gray-500">Desbloqueie todo o potencial do GiroPro</p>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 border-2 border-yellow-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {recursos.map((recurso, index) => (
            <div
              key={index}
              className="relative bg-gradient-to-br from-gray-50 to-yellow-50 rounded-2xl p-6 border-2 border-yellow-200 hover:border-yellow-400 transition-all hover:shadow-xl group"
            >
              {/* Badge "Premium" */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 mb-2 text-lg">{recurso.titulo}</h3>
                  <p className="text-gray-600 leading-relaxed">{recurso.descricao}</p>
                </div>
              </div>

              {/* Overlay de bloqueio */}
              <div className="absolute inset-0 bg-gray-900/5 backdrop-blur-[1px] rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="bg-white rounded-xl px-6 py-3 shadow-xl">
                  <p className="text-sm font-bold text-gray-900">🔒 Disponível no GiroPro+</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="bg-gradient-to-r from-gray-100 to-yellow-100 rounded-2xl p-6 mb-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Gratuito vs Premium</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Gratuito */}
            <div className="bg-white rounded-xl p-6 border-2 border-gray-300">
              <h4 className="font-bold text-gray-900 mb-4 text-xl">Versão Gratuita</h4>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Cálculo de giro básico</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Custo por KM</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Insights gerais</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Histórico simples</span>
                </li>
              </ul>
            </div>

            {/* Premium */}
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-6 border-2 border-yellow-400 relative overflow-hidden">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700 font-medium">Tudo da versão gratuita +</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Horários personalizados com IA</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Análise avançada de desempenho</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Relatórios semanais automáticos</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Melhores regiões em tempo real</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Alertas inteligentes personalizados</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Plano Mensal */}
          <div className="bg-white rounded-2xl p-8 border-2 border-gray-300 hover:border-yellow-400 transition-all hover:shadow-xl">
            <div className="text-center mb-6">
              <p className="text-gray-600 font-medium mb-2">Plano Mensal</p>
            ...
            <button className="w-full bg-gradient-to-r from-gray-600 to-gray-700 text-white font-bold py-4 rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
              Assinar Mensal
            </button>
          </div>

          {/* Plano Anual */}
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-8 border-2 border-yellow-400 hover:border-yellow-500 transition-all hover:shadow-2xl relative">
            ...
            <div className="text-center mb-6">
              <p className="text-gray-700 font-medium mb-2">Plano Anual</p>
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-5xl font-bold text-gray-900">R$ 79</span>
                <span className="text-2xl text-gray-600">,90</span>
                <span className="text-gray-500">/ano</span>
              </div>
              <p className="text-sm text-green-600 font-bold mt-2">R$ 6,66/mês • Economize R$ 39/ano</p>
            </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-3xl p-8 border-2 border-blue-200">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">O Que Dizem Nossos Usuários Premium</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-700 mb-4 italic">"Aumentei meus ganhos em 28% no primeiro mês! Os insights de horários são incríveis."</p>
            <p className="text-sm font-bold text-gray-900">Carlos, Uber - São Paulo</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-700 mb-4 italic">"Finalmente consigo planejar minha semana e sei exatamente onde e quando trabalhar."</p>
            <p className="text-sm font-bold text-gray-900">Ana, 99 - Rio de Janeiro</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-700 mb-4 italic">"Melhor investimento que fiz! Paga sozinho em menos de uma semana de trabalho."</p>
            <p className="text-sm font-bold text-gray-900">João, iFood - Belo Horizonte</p>
          </div>
        </div>
      </div>
    </div>
